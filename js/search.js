    ...
    tmdbRequest(searchTitleUrl(), data => {
        ...
        if (data.results.length === 0) {
            ...
            for (let index in movie_lyst) {
                ...
                title_poster.innerHTML += `<div style="display:inline-block; position:relative; bottom:120px; left: 16px; font-color:white"><i id="${original_title}" class="fa fa-heart liked" style="color: #dadada" ></i><span>&nbsp Like</span></div>`
                ...
                if (star_count === 5) {
                    ...
                    intro.innerHTML += `<div><span style="color: darkcyan">TMBD rating</span> &nbsp<span class="fa fa-star checked"></span>
                                        ...
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span></div>`;
                } else if (star_count === 3) {
                    intro.innerHTML += `<div><span style="color: darkcyan">TMBD rating</span> &nbsp<span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span></div>`;
                    ...
                    intro.innerHTML += `<div><span style="color: darkcyan">TMBD rating</span> &nbsp<span class="fa fa-star" style="color: #dadada"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span>
                                        <span class="fa fa-star" style="color: #dadada"></span></div>`;
